...
4. The clean start-cut is **the preacher's "Let me pray" / equivalent preamble**, which lands 3-5 sec BEFORE the prayer itself begins. The opening prayer IS part of the sermon cut (Chris 2026-07-12 13:23 CT, after two wrong attempts). On 2026-07-12 Sam said "Let me pray and then we'll go into the text" at 22:42 (source time), launched into "Lord God, we come before you right now..." at 22:46, ended with "We love you Lord, amen" at 24:05. **Cut starts at the "Let me pray" line.** Workflow: use faster-whisper with `word_timestamps=True` on a 90-sec slice of the source WAV centered on the expected sermon start, find the prayer begin word in the word-level output, back up to the preacher's preamble. Do NOT include the Opening Scripture, the post-Opening-Scripture prayer, the opening hymn, the kids' dismissal, or the series intro. Do NOT cut at the first detected speech burst — that often catches the post-Opening-Scripture prayer or the kids' dismissal instead of the sermon.
...
- [ ] First 30 seconds is the pastor introducing and leading a brief opening prayer ("Let me pray and then we'll go into the text" + "Lord God, we come before you..."), NOT the kids' dismissal, NOT the series intro, NOT an opening hymn, NOT the Opening Scripture (call to worship). The opening prayer IS part of the cut.
