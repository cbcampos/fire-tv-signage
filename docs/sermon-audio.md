...
3. The clean end-cut is **5-10 sec AFTER the actual concluding prayer's "amen,"** before the **communion / Lord's Supper invitation** or set-up speech begins. Apply a 1-second `afade=t=out` so the cut does not sound chopped. **The preacher's closing prayer ("We love you, Lord, amen" or similar) must be INCLUDED inside the cut** — do not cut at the communion invitation at the expense of the prayer. **Do NOT include the pastoral hand-off** ("Thank you, [name]" from another minister) — that's the liturgy transition, not part of the sermon. On 2026-07-12 the auto-detector caught a false "amen" at 47:10 (p=0.27, mid-sentence, while Sam was still preaching exposition); the real prayer ended with "We love you Lord, amen" at 50:28. Pastoral "Thank you, Sam" at 51:03 marks the hand-off; communion set-up begins at 51:04 ("Well, as we come now to the Lord's table"). Re-cut to 50:33 = 5 sec after the real amen, 30 sec before the pastoral "Thank you, Sam," 31 sec before communion set-up. Final cut: 22:42 → 50:33 (27:51).
4. The clean start-cut is **the preacher's first words**, typically "Good morning, everyone." / "Thanks for having me" / "It's an honor to be here" / or similar opening line. The personal intro IS part of the sermon cut (Chris 2026-07-12 13:34 CT fifth correction, after multiple wrong attempts at "Let me pray" boundaries). On 2026-07-12 Sam opened with "Good morning, everyone." at 1107s (18:27), shared 3 min 35 sec of personal intro (his kids, Brandon's encouragement, a quote from *Preaching Pure and Simple* by Sturt All Yet, his own preparation, the humility of approaching the text), then said "Let me pray and then we'll go into the text." at 1361s, then opened the prayer at 22:46. **Cut starts at "Good morning"** (or the preacher's equivalent first line). Workflow: use faster-whisper with `word_timestamps=True` on a 120-sec slice of the source WAV starting ~90 sec before the expected sermon start (so 30 sec before the preacher's first word). The preacher's intro starts at the first speaker turn where they say something personal — typically after a brief pastoral hand-off ("You can have a seat" / "Sam's going to bring us the word") and after the closing worship song fades. Do NOT include the closing worship song itself ("A thousand hallelujahs" or similar); do NOT include the brief pastoral hand-off ("You can have a seat"); do NOT include the Opening Scripture, the post-Opening-Scripture prayer, the opening hymn, the kids' dismissal, or the series intro. Do NOT cut at "Let me pray" — that's mid-sermon, not the start.

### Per-week verification checklist

After re-cutting, before uploading:

- [ ] Last 30 seconds of the MP3 ends in the concluding prayer's "amen" + 5-10 sec of tail silence. It does NOT include the communion / Lord's Supper invitation ("as we come now to the Lord's table" or "In 1 Corinthians 11..."), and does NOT include the pastoral hand-off ("Thank you, [name]" from another minister). Use faster-whisper to find candidate "amen" detections; verify each is the FINAL word of a coherent prayer (not mid-sentence or the name "Amen" elsewhere). Cut at 5-10 sec after the verified real amen.
- [ ] First 30 seconds is the pastor's "Good morning, everyone." opener, NOT the kids' dismissal, NOT the series intro, NOT an opening hymn, NOT the Opening Scripture (call to worship), NOT the closing worship song (the song that plays just before the sermon — "A thousand hallelujahs" or similar), NOT the brief pastoral hand-off ("You can have a seat" / "[Name]'s going to bring us the word"). The personal intro AND the opening prayer are both part of the cut.
